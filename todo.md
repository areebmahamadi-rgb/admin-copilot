...
- [x] Three-column layout: FYI (left) / Respond (middle) / Deep Work (right)
- [ ] Real-time data refresh — pull fresh MCP data on every load, not stale cache (next up)
- [x] Full Slack conversation history — show recent thread context inline on collapsed cards
